...
export function PremiumProfilePanel({ name, phone, couponCode, onCouponChange, discountUsage, onBack, onLogout, onOrders, onHome, onPolicy }: { name: string; phone?: string; couponCode: string; onCouponChange: (value: string) => void; discountUsage: DiscountUsage[]; onBack: () => void; onLogout: () => void; onOrders: () => void; onHome: () => void; onPolicy: () => void }) {
  ...
  return <View style={styles.root}>
    <ScrollView keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" contentContainerStyle={[styles.content, { paddingTop: Math.max(insets.top + 12, 24), paddingBottom: Math.max(insets.bottom + 104, 124) }]}>
      <View style={styles.headerRow}><Pressable accessibilityLabel="العودة من الملف الشخصي" onPress={onBack} style={({ pressed }) => [styles.iconButton, pressed && styles.pressed]}><MaterialIcons name="arrow-forward" size={21} color="#431407" /></Pressable><Text style={styles.headerTitle}>الحساب</Text><View style={styles.headerSpacer} /></View>
      <View style={styles.hero}>
        ...
        <Pressable accessibilityLabel="تعديل الملف الشخصي" onPress={onPolicy} style={({ pressed }) => [styles.editButton, pressed && styles.pressed]}><MaterialIcons name="edit" size={17} color="#EA580C" /></Pressable>
      </View>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: "#431407", fontSize: 21, fontWeight: "900" },
  headerSpacer: { width: 42 },
  iconButton: { width: 42, height: 42, borderRadius: 14, alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF", shadowColor: "#431407", shadowOpacity: 0.07, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 2 },
  hero: { position: "relative", overflow: "hidden", flexDirection: "row-reverse", alignItems: "center", gap: 12, padding: 17, borderRadius: 24, backgroundColor: "#FFF7ED" },
  heroGlow: { position: "absolute", width: 150, height: 150, borderRadius: 75, top: -68, left: -28, backgroundColor: "#D3EBDD" },
  avatar: { width: 66, height: 66, borderRadius: 23, alignItems: "center", justifyContent: "center", backgroundColor: "#EA580C", borderWidth: 4, borderColor: "#FFFFFF" },
  ...
  role: { color: "#EA580C", fontSize: 10, fontWeight: "900", marginTop: 6 },
  editButton: { width: 34, height: 34, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF" },
  statsRow: { flexDirection: "row-reverse", alignItems: "center", paddingVertical: 13, borderRadius: 18, backgroundColor: "#FFFFFF", shadowColor: "#431407", shadowOpacity: 0.05, shadowRadius: 10, shadowOffset: { width: 0, height: 3 }, elevation: 2 },
  stat: { flex: 1, alignItems: "center", gap: 3 },
  statValue: { color: "#431407", fontSize: 17, fontWeight: "900" },
  statLabel: { color: "#A8A29E", fontSize: 10, fontWeight: "800" },
  ...
  menuRow: { minHeight: 67, flexDirection: "row-reverse", alignItems: "center", gap: 11, paddingHorizontal: 13, borderBottomWidth: 1, borderBottomColor: "#FFF7ED" },
  menuRowDisabled: { opacity: 0.72 },
  menuPressed: { backgroundColor: "#FFF7ED" },
  menuIcon: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "#FFF7ED" },
  menuCopy: { flex: 1, alignItems: "flex-end" },
  menuTitle: { color: "#431407", fontSize: 12, fontWeight: "900", textAlign: "right" },
  ...
  couponTitle: { color: "#431407", fontSize: 13, fontWeight: "900" },
  couponInput: { minHeight: 48, borderRadius: 14, backgroundColor: "#F4F8F5", borderWidth: 1, borderColor: "#DDE9E1", paddingHorizontal: 13, color: "#431407", fontWeight: "800" },
  couponActions: { flexDirection: "row-reverse", gap: 8 },
  couponSave: { flex: 1, minHeight: 42, borderRadius: 13, alignItems: "center", justifyContent: "center", backgroundColor: "#EA580C" },
  ...
  couponClearText: { color: "#B91C1C", fontSize: 12, fontWeight: "900" },
  qrButton: { minHeight: 42, borderRadius: 13, paddingHorizontal: 12, flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 5, backgroundColor: "#FFF7ED" },
  qrButtonText: { color: "#EA580C", fontSize: 11, fontWeight: "900" },
  couponHint: { color: "#A8A29E", fontSize: 10, textAlign: "right" },
  historyBox: { borderRadius: 19, backgroundColor: "#FFFFFF", padding: 14, gap: 10 },
  historyRow: { minHeight: 54, flexDirection: "row-reverse", alignItems: "center", gap: 10, borderTopWidth: 1, borderTopColor: "#FFF7ED", paddingTop: 9 },
  remaining: { color: "#EA580C", fontSize: 10, fontWeight: "900" },
  accountSection: { gap: 10, marginTop: 2 },
  logoutRow: { minHeight: 63, flexDirection: "row-reverse", alignItems: "center", gap: 11, paddingHorizontal: 13, borderRadius: 18, backgroundColor: "#FFF7ED" },
  logoutIcon: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "#FDEAE7" },
  logoutTitle: { color: "#B91C1C", fontSize: 12, fontWeight: "900", textAlign: "right" },
