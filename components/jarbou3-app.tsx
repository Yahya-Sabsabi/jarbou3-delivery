...
const driverProfileStyles = StyleSheet.create({ driverProfileScroll: { flexGrow: 1, alignItems: 'center', paddingHorizontal: 20, gap: 14, backgroundColor: '#F5F7F5' }, driverProfileBack: { alignSelf: 'flex-start', width: 44, height: 44, borderRadius: 14, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, driverProfileAvatar: { width: 82, height: 82, borderRadius: 28, backgroundColor: '#24755E', alignItems: 'center', justifyContent: 'center', marginTop: 8 }, driverProfileAvatarText: { color: '#FFFFFF', fontSize: 34, fontWeight: '900' }, driverProfileTitle: { color: dark, fontSize: 24, fontWeight: '900' }, driverProfileSubtitle: { color: '#6D7C74', fontSize: 12, textAlign: 'center' }, driverProfileCard: { width: '100%', backgroundColor: '#FFFFFF', borderRadius: 20, padding: 16, marginTop: 8 }, driverProfileRow: { minHeight: 40, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between', gap: 12 }, driverProfileLabel: { color: '#829087', fontSize: 11, fontWeight: '700' }, driverProfileValue: { color: dark, fontSize: 13, fontWeight: '900', textAlign: 'right', flexShrink: 1 }, driverProfileDivider: { height: 1, backgroundColor: '#EEF2EF', marginVertical: 8 }, driverProfileHint: { color: '#718078', fontSize: 11, lineHeight: 18, textAlign: 'right', width: '100%' }, driverProfileLogout: { width: '100%', minHeight: 52, borderRadius: 16, borderWidth: 1, borderColor: '#D9B3B3', flexDirection: 'row-reverse', gap: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFF8F8' }, driverProfileLogoutText: { color: '#A33E3E', fontSize: 14, fontWeight: '900' }, driverProfileButton: { width: 42, height: 42, borderRadius: 14, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' } });
