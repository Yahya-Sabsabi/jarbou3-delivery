...
function Customer({ name, onTripActivity }: { name: string; onTripActivity: (active: boolean) => void }) {
  ...
  if (page === "order") return (
    <OptimusMapScreen
      ...
      locating={locating}
      onProfile={() => Alert.alert("الملف الشخصي", "يمكنك إدارة بيانات حسابك من مساحة الحساب.")}
    >
