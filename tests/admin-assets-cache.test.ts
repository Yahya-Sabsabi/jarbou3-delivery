...
describe("حزمة لوحة الإدارة المنشورة", () => {
  it("تحمل أصولاً cache-busted وتحتوي إصلاحات كلمة المرور ورسائل dashboard", () => {
    ...
    expect(index).toContain("app.20260921-13.js");
    expect(index).toContain("live-map.20260921-13.js");
    const app = fs.readFileSync(path.join(root, "app.20260921-13.js"), "utf8");
